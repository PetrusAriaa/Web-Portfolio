...
export const Hero = () => {
  ...
  return (
    <section about="jumbotron" className="relative overflow-hidden z-[10] flex flex-col items-center justify-center text-myWhite font-semibold text-5xl min-h-screen w-full">
      <Image ref={avatar.ref} src={Avatar} alt="My Avatar" className="absolute  w-screen"/>
      <Image ref={lightning1.ref} src={Lightning1} alt="lightning1" className="absolute z-[43] w-screen"/>
      <Image ref={lightning2.ref} src={Lightning2} alt="lightning2" className="absolute z-[42] w-screen"/>
      <Image ref={lightning3.ref} src={Lightning3} alt="lightning3" className="absolute z-[41] w-screen"/>
