    ...
    <section
      ...
      <div className="w-4/5 flex flex-col gap-5 lg:gap-4 ">
        <div className="flex flex-col gap-4">
          <h1 className="text-myBlue1 text-3xl font-semibold md:text-5xl">Backstory</h1>
        ...
        <div className="flex flex-col-reverse md:flex-row justify-center gap-10 lg:h-[60vh]">
          ...
          <div className="w-full md:w-2/3 flex flex-col gap-6 lg:gap-10">
            <div className="flex flex-row justify-center md:justify-start gap-4 lg:gap-8">
              <div onClick={()=>{
                ...
                className={`cursor-pointer text-xs sm:text-sm select-none transition-colors duration-200 font-medium py-1 flex flex-col gap-2 after:h-[2px] after:bg-myBlue1 after:transition-transform hover:text-myBlue1 `+(
                  activeSwiper === 0 ? "after:scale-x-100 text-myBlue1" : "after:scale-x-0 text-myWhite"
                )}>
                  Languages</div>
              <div onClick={()=>{
                setActiveSwiper(1)
                ...
                className={`cursor-pointer text-xs sm:text-sm select-none transition-colors duration-200 font-medium py-1 flex flex-col gap-2 after:h-[2px] after:bg-myBlue1 after:transition-transform hover:text-myBlue1 `+(
                  activeSwiper === 1 ? "after:scale-x-100 text-myBlue1" : "after:scale-x-0 text-myWhite"
                )}>
                  Frontend</div>
              <div onClick={()=>{
                setActiveSwiper(2)
                ...
                className={`cursor-pointer text-xs sm:text-sm select-none transition-colors duration-200 font-medium py-1 flex flex-col gap-2 after:h-[2px] after:bg-myBlue1 after:transition-transform hover:text-myBlue1 `+(
                  activeSwiper === 2 ? "after:scale-x-100 text-myBlue1" : "after:scale-x-0 text-myWhite"
                )}>
                  Backend</div>
              <div onClick={()=>{
                setActiveSwiper(3)
                ...
                className={`cursor-pointer text-xs sm:text-sm select-none transition-colors duration-200 font-medium py-1 flex flex-col gap-2 after:h-[2px] after:bg-myBlue1 after:transition-transform hover:text-myBlue1 `+(
                  activeSwiper === 3 ? "after:scale-x-100 text-myBlue1" : "after:scale-x-0 text-myWhite"
                )}>
                  Tools</div>
            </div>
          ...
          <div className="flex justify-center w-full">
            <div className="h-48 lg:h-96 w-full bg-slate-300/30 animate-pulse"></div>
          </div>
        </div>
      </div>
    </section>
